...
const GAME_THEME = Object.freeze({
  ...
  knockoutDrawTitle: "Knockout Draw",
  knockoutDrawSubtitle: "Eight stamps earned. Historical champions await in the bracket.",
  knockoutPrepTitle: "Knockout Stage",
  worldCupWinTitle: "WORLD CUP<br>LIFTED!",
  worldCupWinSubtitle: "Your squad conquered the historical gauntlet.",
  worldCupWinKicker: "Campaign complete — settlement awaits",
  worldCupSettlementCta: "Continue to Settlement",
  trophyRoomTitle: "Trophy Room",
