...
const routes = [
  ...
  { path: "/js/domain/knockout.js", includes: "DomainKnockout" },
  { path: "/js/domain/meta.js", includes: "DomainMeta" },
  { path: "/data/football/knockout_teams.json", includes: "\"gates\"" },
  { path: "/data/football/run_economy.json", includes: "\"credits\"" },
  { path: "/assets/ui/world-cup-trophy.svg", includes: "World Cup Trophy" },
